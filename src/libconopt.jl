...
function COI_Solve(cntvect)
    ccall((:COI_Solve, libconopt), Cint, (coiHandle_t,), cntvect)
end

function COIGET_Version(major, minor, patch)
    ccall((:COIGET_Version, libconopt), Cvoid, (Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), major, minor, patch)
end

function COIGET_MaxThreads(cntvect)
    ccall((:COIGET_MaxThreads, libconopt), Cint, (coiHandle_t,), cntvect)
end

function COIGET_MaxHeapUsed(cntvect)
    ccall((:COIGET_MaxHeapUsed, libconopt), Cdouble, (coiHandle_t,), cntvect)
end
...
function COI_Finalize()
    ccall((:COI_Finalize, libconopt), Cvoid, ())
end

function COIDEF_NumVar(cntvect, numvar)
    ccall((:COIDEF_NumVar, libconopt), Cint, (coiHandle_t, Cint), cntvect, numvar)
end

function COIDEF_NumCon(cntvect, numcon)
    ccall((:COIDEF_NumCon, libconopt), Cint, (coiHandle_t, Cint), cntvect, numcon)
end

function COIDEF_NumNz(cntvect, numnz)
    ccall((:COIDEF_NumNz, libconopt), Cint, (coiHandle_t, Cint), cntvect, numnz)
end

function COIDEF_NumNlNz(cntvect, numnlnz)
    ccall((:COIDEF_NumNlNz, libconopt), Cint, (coiHandle_t, Cint), cntvect, numnlnz)
end

function COIDEF_NumHess(cntvect, numhess)
    ccall((:COIDEF_NumHess, libconopt), Cint, (coiHandle_t, Cint), cntvect, numhess)
end

function COIDEF_OptDir(cntvect, optdir)
    ccall((:COIDEF_OptDir, libconopt), Cint, (coiHandle_t, Cint), cntvect, optdir)
end

function COIDEF_ObjVar(cntvect, objvar)
    ccall((:COIDEF_ObjVar, libconopt), Cint, (coiHandle_t, Cint), cntvect, objvar)
end

function COIDEF_ObjCon(cntvect, objcon)
    ccall((:COIDEF_ObjCon, libconopt), Cint, (coiHandle_t, Cint), cntvect, objcon)
end

function COIDEF_License(cntvect, licint1, licint2, licint3, licstring)
    ccall((:COIDEF_License, libconopt), Cint, (coiHandle_t, Cint, Cint, Cint, Ptr{Cchar}), cntvect, licint1, licint2, licint3, licstring)
end

function COIDEF_ItLim(cntvect, itlim)
    ccall((:COIDEF_ItLim, libconopt), Cint, (coiHandle_t, Cint), cntvect, itlim)
end

function COIDEF_ErrLim(cntvect, errlim)
    ccall((:COIDEF_ErrLim, libconopt), Cint, (coiHandle_t, Cint), cntvect, errlim)
end

function COIDEF_ResLim(cntvect, reslim)
    ccall((:COIDEF_ResLim, libconopt), Cint, (coiHandle_t, Cdouble), cntvect, reslim)
end

function COIDEF_MaxHeap(cntvect, maxheap)
    ccall((:COIDEF_MaxHeap, libconopt), Cint, (coiHandle_t, Cdouble), cntvect, maxheap)
end

function COIDEF_IniStat(cntvect, inistat)
    ccall((:COIDEF_IniStat, libconopt), Cint, (coiHandle_t, Cint), cntvect, inistat)
end

function COIDEF_FVincLin(cntvect, fvinclin)
    ccall((:COIDEF_FVincLin, libconopt), Cint, (coiHandle_t, Cint), cntvect, fvinclin)
end

function COIDEF_FVforAll(cntvect, fvforall)
    ccall((:COIDEF_FVforAll, libconopt), Cint, (coiHandle_t, Cint), cntvect, fvforall)
end

function COIDEF_MaxSup(cntvect, maxsup)
    ccall((:COIDEF_MaxSup, libconopt), Cint, (coiHandle_t, Cint), cntvect, maxsup)
end

function COIDEF_Square(cntvect, square)
    ccall((:COIDEF_Square, libconopt), Cint, (coiHandle_t, Cint), cntvect, square)
end

function COIDEF_EmptyRow(cntvect, emptyrow)
    ccall((:COIDEF_EmptyRow, libconopt), Cint, (coiHandle_t, Cint), cntvect, emptyrow)
end

function COIDEF_EmptyCol(cntvect, emptycol)
    ccall((:COIDEF_EmptyCol, libconopt), Cint, (coiHandle_t, Cint), cntvect, emptycol)
end

function COIDEF_DisCont(cntvect, discont)
    ccall((:COIDEF_DisCont, libconopt), Cint, (coiHandle_t, Cint), cntvect, discont)
end

function COIDEF_HessFac(cntvect, hessfac)
    ccall((:COIDEF_HessFac, libconopt), Cint, (coiHandle_t, Cdouble), cntvect, hessfac)
end

function COIDEF_DebugFV(cntvect, debugfv)
    ccall((:COIDEF_DebugFV, libconopt), Cint, (coiHandle_t, Cint), cntvect, debugfv)
end

function COIDEF_Debug2D(cntvect, debug2d)
    ccall((:COIDEF_Debug2D, libconopt), Cint, (coiHandle_t, Cint), cntvect, debug2d)
end

function COIDEF_ClearM(cntvect, clearm)
    ccall((:COIDEF_ClearM, libconopt), Cint, (coiHandle_t, Cint), cntvect, clearm)
end

function COIDEF_ThreadS(cntvect, threads)
    ccall((:COIDEF_ThreadS, libconopt), Cint, (coiHandle_t, Cint), cntvect, threads)
end

function COIDEF_ThreadF(cntvect, threadf)
    ccall((:COIDEF_ThreadF, libconopt), Cint, (coiHandle_t, Cint), cntvect, threadf)
end

function COIDEF_Thread2D(cntvect, thread2d)
    ccall((:COIDEF_Thread2D, libconopt), Cint, (coiHandle_t, Cint), cntvect, thread2d)
end

function COIDEF_ThreadC(cntvect, threadc)
    ccall((:COIDEF_ThreadC, libconopt), Cint, (coiHandle_t, Cint), cntvect, threadc)
end

function COIDEF_StdOut(cntvect, tostdout)
    ccall((:COIDEF_StdOut, libconopt), Cint, (coiHandle_t, Cint), cntvect, tostdout)
end

function COIDEF_Optfile(cntvect, optfile)
    ccall((:COIDEF_Optfile, libconopt), Cint, (coiHandle_t, Ptr{Cchar}), cntvect, optfile)
end

function COIDEF_ReadMatrix(cntvect, coi_readmatrix)
    ccall((:COIDEF_ReadMatrix, libconopt), Cint, (coiHandle_t, COI_READMATRIX_t), cntvect, coi_readmatrix)
end

function COIDEF_FDEval(cntvect, coi_fdeval)
    ccall((:COIDEF_FDEval, libconopt), Cint, (coiHandle_t, COI_FDEVAL_t), cntvect, coi_fdeval)
end

function COIDEF_FDEvalIni(cntvect, coi_fdevalini)
    ccall((:COIDEF_FDEvalIni, libconopt), Cint, (coiHandle_t, COI_FDEVALINI_t), cntvect, coi_fdevalini)
end

function COIDEF_FDEvalEnd(cntvect, coi_fdevalend)
    ccall((:COIDEF_FDEvalEnd, libconopt), Cint, (coiHandle_t, COI_FDEVALEND_t), cntvect, coi_fdevalend)
end

function COIDEF_Status(cntvect, coi_status)
    ccall((:COIDEF_Status, libconopt), Cint, (coiHandle_t, COI_STATUS_t), cntvect, coi_status)
end

function COIDEF_Solution(cntvect, coi_solution)
    ccall((:COIDEF_Solution, libconopt), Cint, (coiHandle_t, COI_SOLUTION_t), cntvect, coi_solution)
end
...
function COIDEF_Progress(cntvect, coi_progress)
    ccall((:COIDEF_Progress, libconopt), Cint, (coiHandle_t, COI_PROGRESS_t), cntvect, coi_progress)
end

function COIDEF_Option(cntvect, coi_option)
    ccall((:COIDEF_Option, libconopt), Cint, (coiHandle_t, COI_OPTION_t), cntvect, coi_option)
end

function COIDEF_TriOrd(cntvect, coi_triord)
    ccall((:COIDEF_TriOrd, libconopt), Cint, (coiHandle_t, COI_TRIORD_t), cntvect, coi_triord)
end

function COIDEF_FDInterval(cntvect, coi_fdinterval)
    ccall((:COIDEF_FDInterval, libconopt), Cint, (coiHandle_t, COI_FDINTERVAL_t), cntvect, coi_fdinterval)
end

function COIDEF_2DDir(cntvect, coi_2ddir)
    ccall((:COIDEF_2DDir, libconopt), Cint, (coiHandle_t, COI_2DDIR_t), cntvect, coi_2ddir)
end

function COIDEF_2DDirIni(cntvect, coi_2ddirini)
    ccall((:COIDEF_2DDirIni, libconopt), Cint, (coiHandle_t, COI_2DDIRINI_t), cntvect, coi_2ddirini)
end

function COIDEF_2DDirEnd(cntvect, coi_2ddirend)
    ccall((:COIDEF_2DDirEnd, libconopt), Cint, (coiHandle_t, COI_2DDIREND_t), cntvect, coi_2ddirend)
end

function COIDEF_2DDirLagr(cntvect, coi_2ddirlagr)
    ccall((:COIDEF_2DDirLagr, libconopt), Cint, (coiHandle_t, COI_2DDIRLAGR_t), cntvect, coi_2ddirlagr)
end

function COIDEF_2DLagrSize(cntvect, coi_2dlagrsize)
    ccall((:COIDEF_2DLagrSize, libconopt), Cint, (coiHandle_t, COI_2DLAGRSIZE_t), cntvect, coi_2dlagrsize)
end

function COIDEF_2DLagrStr(cntvect, coi_2dlagrstr)
    ccall((:COIDEF_2DLagrStr, libconopt), Cint, (coiHandle_t, COI_2DLAGRSTR_t), cntvect, coi_2dlagrstr)
end

function COIDEF_2DLagrVal(cntvect, coi_2dlagrval)
    ccall((:COIDEF_2DLagrVal, libconopt), Cint, (coiHandle_t, COI_2DLAGRVAL_t), cntvect, coi_2dlagrval)
end

function COIDEF_UsrMem(cntvect, usrmem)
    ccall((:COIDEF_UsrMem, libconopt), Cint, (coiHandle_t, Ptr{Cvoid}), cntvect, usrmem)
end
